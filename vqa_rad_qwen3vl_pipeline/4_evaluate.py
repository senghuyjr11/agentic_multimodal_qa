"""
Step 4: Evaluate fine-tuned Qwen3-VL-8B-Instruct on VQA-RAD test set
...
print("=" * 70)
print("VQA-RAD EVALUATION — Qwen3-VL-8B-Instruct")
print("=" * 70 + "\n")
...
# ========== PRINT ==========
print("\n" + "=" * 70)
print("FINAL RESULTS — Qwen3-VL-8B on VQA-RAD")
print("=" * 70)
