...
def main():
    ...
    def fast_collator(batch):
        """
        Collator for preprocessed VQA-RAD samples:
        - input_ids: [seq_len]
        ...
        # image_grid_thw: each [1, 3] -> [B, 3] (Qwen3-VL is okay with [B, 3])
    ...
    train_dataset = CachedDataset("preprocessed_vqa_rad_qwen3/train/preprocessed_data.pt")
    val_dataset = CachedDataset("preprocessed_vqa_rad_qwen3/val/preprocessed_data.pt")
    ...
    training_args = TrainingArguments(
        ...
        learning_rate=2e-5,  # from 5e-5
        num_train_epochs=3,  # from 6
        ...
        # Data loading
        tf32=True,  # minor speedup on Ampere+ GPUs
    )
    ...
    try:
        ...
        trainer.save_model("./qwen3vl_2b_vqa_rad_interrupted")
        print("✓ Saved interrupted checkpoint to ./qwen3vl_2b_vqa_rad_interrupted")
        ...
        torch.cuda.empty_cache()
        try:
            trainer.save_model("./qwen3vl_2b_vqa_rad_emergency")
            print("✓ Emergency save to ./qwen3vl_2b_vqa_rad_emergency")
        except:
    ...
    print("\nSaving final model...")
    if TEST_MODE:
        model.save_pretrained("./qwen3vl_2b_vqa_rad_test_adapters")
        processor.save_pretrained("./qwen3vl_2b_vqa_rad_test_adapters")
        print("✓ Test model saved to ./qwen3vl_2b_vqa_rad_test_adapters")
    else:
        model.save_pretrained("./qwen3vl_2b_vqa_rad_adapters")
        processor.save_pretrained("./qwen3vl_2b_vqa_rad_adapters")
        print("✓ Model saved to ./qwen3vl_2b_vqa_rad_adapters")
    ...
    if TEST_MODE:
        ...
        # Load test data
        test_dataset = CachedDataset("preprocessed_vqa_rad/test/preprocessed_data.pt")
