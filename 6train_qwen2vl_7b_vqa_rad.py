"""
Complete Training Script for VQA-RAD with Qwen2-VL
...
def main():
    ...
    train_dataset = CachedDataset("preprocessed_vqa_rad/train/preprocessed_data.pt")
    val_dataset = CachedDataset("preprocessed_vqa_rad/val/preprocessed_data.pt")
