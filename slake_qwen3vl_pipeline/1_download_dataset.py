"""
Step 1: Download SLAKE (English) dataset from HuggingFace
Saves images + CSV files for train / validation / test splits
...
# SLAKE uses "validation" — remap to "val" for our pipeline
splits = {
    "train": dataset["train"],
