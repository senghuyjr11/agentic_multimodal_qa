"""
Step 4: Evaluate fine-tuned MedGemma 4B IT on PathVQA test set
...
print("=" * 70)
print("PATH-VQA EVALUATION — MedGemma 4B IT")
    ...
    try:
        ...
        with torch.no_grad():
            if closed:
                ...
                pred_text = normalize(processor.tokenizer.decode(new_tokens, skip_special_tokens=True))
...
print("\n" + "=" * 70)
print("FINAL RESULTS — MedGemma 4B IT on PathVQA")
print("=" * 70)
