...
if __name__ == "__main__":
    ...
    # Save to NEW directory to avoid confusion
    TRAIN_OUTPUT = "preprocessed_data_v2/train"
    VAL_OUTPUT = "preprocessed_data_v2/val"
    TEST_OUTPUT = "preprocessed_data_v2/test"
    ...
    print(f"\nData saved to: preprocessed_data_v2/")
    print("\n⚠️  UPDATE YOUR TRAINING SCRIPT:")
    print("   Change paths to: preprocessed_data_v2/")
    print("="*60)